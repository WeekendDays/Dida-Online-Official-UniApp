...
import com.yang.emos.wx.db.pojo.MessageRefEntity;
...
public class MessageDao {
    ...
    public List<HashMap> searchMessageByPage(int userId, long start, int length){
        ...
        list.forEach(one -> {
            List<MessageRefEntity> refLists = (List<MessageRefEntity>) one.get("ref");
            MessageRefEntity entity = refLists.get(0);
